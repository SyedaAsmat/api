...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=399279896ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api&table=comment">`api`.`comment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api&table=article">`api`.`article`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api&table=user">`api`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=api&table=articles">`api`.`articles`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3b6e692d5721237d7331375c435a4224">
    ...
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="api" targettable="article">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `article`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="api" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `article`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="api" targettable="comment">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
