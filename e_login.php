...
<html>
	<head>
        <h2 Align="center">Editor Login</h2>
    </head>
    <body>
		<form method="post" name="Editor Login" enctype = "multipart/form-data" Align="center">
            <table Align="center" cellpadding="2" cellspacing="3">
            <tr>
                    <th><Label></Label></th>
                    <td><input class="" type="hidden"name="role" maxlength="20" placeholder="" autocomplete="off"> </td>
                </tr>
                <tr>
                ...
                if ($res = mysqli_query($conn, $sql)) { 
                    if (mysqli_num_rows($res) > 0) {
                        while ($row = mysqli_fetch_array($res)) {
                            ...
                            echo "<script>location.replace('e_dash.php');</script>";
                        } 
                    }else {
